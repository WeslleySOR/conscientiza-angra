...
export function AboutSelectiveCollection() {
  ...
  return (
    <>
      <div
        className="scroll-mt-[80px] mt-4 relative flex odd:bg-[#262626]"
        id="sobre-a-coleta"
      >
        <div ref={sliderRef} className="keen-slider">
          <div className="keen-slider__slide number-slide1 select-none flex flex-col flex-1 gap-8 pt-16 pb-24 bg-[#343434] text-[#fff] transition-opacity duration-200 hover:opacity-90">
          ...
          <div className="keen-slider__slide number-slide1 select-none flex flex-col flex-1 gap-8 pt-16 pb-24 bg-[#343434] text-[#fff] transition-opacity duration-200 hover:opacity-90">
            <h1 className="text-lg text-center">VOCE SABE QUE SEU LIXO TEM VALOR?</h1>
            <span className="text-base text-center px-4">
          ...
          {[
            ...
            return (
              <button
                ...
                className={"border-none w-3 h-3 bg-[#c5c5c5] rounded-[50%] mx-1 p-1 cursor-pointer " + (currentSlide === idx ? "bg-[#000]" : "")}
              ></button>
            );
          })}
        </div>
